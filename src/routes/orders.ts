...
import { createCheckout, createOrder, deleteOrder, EditOrderStatus, getOrderById, getOrdersBySearch, listOrders, totalOnOrderDashboard } from "../controllers/orders";
...
orderRoutes.get("/search/:search", [authMiddleWare, adminMiddleWare], errorHandler(getOrdersBySearch))
